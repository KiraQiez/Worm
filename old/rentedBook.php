    ...
    <div class="main-content">
        <div class="content">
            ...
            <div class="book-container">
                <div class="book">
                    <h3>All Marketers Are Liars</h3>
                    <img src="Items/allmal.jpg" alt="All Marketers Are Liars">
                    <p>Book ID: B011</p>
                    <p>Type: Business</p>
                    <p>Rental: RM 3.00</p>
                    <p>Deposit: RM 30.20</p><br>
                    <p>20/8/2024 - 19/9/2024</p>
                </div>
                <div class="book">
                    <h3>Death On The Nile</h3>
                    <img src="Items/dotn.jpg" alt="Death On The Nile">
                    <p>Book ID: B012</p>
                    <p>Type: Fiction</p>
                    <p>Rental: RM 5.00</p>
                    <p>Deposit: RM 25.00</p><br>
                    <p>12/8/2024 - 11/9/2024</p>
                </div>
                <div class="book">
                    <h3>The 80/20 Principle</h3>
                    <img src="Items/principle.jpg" alt="The 80/20 Principle">
                    <p>Book ID: B013</p>
                    <p>Type: Fiction</p>
                    <p>Rental: RM 5.00</p>
                    <p>Deposit: RM 25.00</p><br>
                    <p>1/8/2024 - 2/9/2024</p>
                </div>
            </div>
        </div>
    </div>
